            ...
            <LinearGradient colors={["#7F7FD5", "#E9E4F0"]} style={{ flex: 1 }}>
                <View style={{ padding: 12 }}>
                    ...
                    <View style={{ marginTop: 20, flexDirection: "row", alignItems: 'center', gap: 20 }}>
                        <Pressable style={{ backgroundColor: "#D3CCE3", padding: 12, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flex: 1 }} onPress={() => router.push('/(home)/employees')}>
                    ...
                    <View style={{ marginTop: 20, backgroundColor: 'white', paddingHorizontal: 10, paddingVertical: 10, borderRadius: 7 }}>
                        <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginVertical: 10 }}>
                        ...
                        <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginVertical: 10 }}>
                            ...
                            <Text style={{ marginLeft: 10, fontSize: 16, fontWeight: '600', flex: 1 }}>All Generate Reports</Text>
                            <View style={{ width: 35, height: 35, borderRadius: 7, backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' }}>
                                <Entypo name="chevron-right" size={24} color="black" />
                            </View>
                        </Pressable>
                    ...
                    <View style={{ marginTop: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                        <View style={{ backgroundColor: '#D3CCE3', flex: 1, borderRadius: 6, padding: 12, alignItems: 'center', justifyContent: 'center' }}>
                            <View style={{ width: 35, height: 35, borderRadius: 7, backgroundColor: 'white', alignItems: "center", justifyContent: 'center' }}>
                                <MaterialCommunityIcons name="guy-fawkes-mask" size={24} color="black" />
                            </View>
                            <Text style={{ marginTop: 7 }}>Cost Savings</Text>
                        </View>
                        <View style={{ backgroundColor: '#BDC3C7', flex: 1, borderRadius: 6, padding: 12, alignItems: 'center', justifyContent: 'center' }}>
                            <View style={{ width: 35, height: 35, borderRadius: 7, backgroundColor: 'white', alignItems: "center", justifyContent: 'center' }}>
                                <Feather name="bar-chart" size={24} color="black" />
                            </View>
